...
def default_classification_model(
    ...
    outputs = keras.layers.Reshape((-1,num_classes,9), name='pyramid_classification_reshape')(outputs)
...
def default_regression_model(num_values, num_anchors, pyramid_feature_size=256, regression_feature_size=256, name='regression_submodel'):
    ...
    #outputs = keras.layers.Conv3D(1,(3,3,1),padding='same')(outputs)
    #outputs = keras.layers.Reshape((-1,1, num_values), name='pyramid_regression_reshape1')(outputs)
    outputs = keras.layers.Reshape((-1, num_values,9), name='pyramid_regression_reshape')(outputs)
